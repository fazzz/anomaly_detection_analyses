...
for r in ${sparsity[*]}; do
    ...
    cat <<EOF > mol_nst-ave-ss-d_r-r_2_sp=${r}.tcl
axes location off
...
EOF
    ...
    cat ${anomaly}/draw_line_between_ca_ca_open_sp=${r} >> mol_nst-ave-ss-d_r-r_2_sp=${r}.tcl
...
EOF
    ...
    cat ${anomaly}/draw_line_between_ca_ca_close_sp=${r} >> mol_nst-ave-ss-d_r-r_2_sp=${r}.tcl

    cat <<EOF >> mol_nst-ave-ss-d_r-r_2_sp=${r}.tcl

set filename nst-ave-ss-d_r-r_2_sp=${r}
