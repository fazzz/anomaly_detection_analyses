...
set output "histgram_a_e_r-r_sparsity-effect.eps"
...
xmin=0.2
xmax=0.8
set xtics 0.3,0.1,0.7
set xrange [xmin:xmax]

plot "num_of_non-zero-elements_a_e_r-r_A.txt" u ($2-0.02):1 w boxes lw 2 lc rgb "pink" notitle, \
     "num_of_non-zero-elements_a_e_r-r_B.txt" u ($2+0.02):1 w boxes lw 2 lc rgb "light-blue" notitle
