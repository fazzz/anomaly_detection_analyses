...
plot \\
     "../anomaly_d_r-r_2/a_d_r-r_sp=${s}_anomaly_top10_pairs.txt" u 1:2 w p pt 7 ps 2.0 lc rgb "black" notitle, \\
     "../anomaly_d_r-r_2/a_d_r-r_sp=${s}_anomaly_top11-20_pairs.txt" u 1:2 w p pt 7 ps 1.5 lc rgb "black" notitle, \\
     "../anomaly_d_r-r_2/a_d_r-r_sp=${s}_anomaly_top21-30_pairs.txt" u 1:2 w p pt 7 ps 1.0 lc rgb "black" notitle, \\
     "../anomaly_d_r-r_2/a_d_r-r_sp=${s}_anomaly_top31-40_pairs.txt" u 1:2 w p pt 7 ps 0.5 lc rgb "black" notitle, \\
